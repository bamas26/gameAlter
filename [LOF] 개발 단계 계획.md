...
# 분석
    ...
    - D + n 일 리텐션 지표 확인
    - 방치형 게임의 특성상 D + n 일에 추가되는 새로운 컨텐츠가 리텐션 지표에 영향을 줌
    - 실제 CPI 테스트를 할만한 분량을 제작 했는가가 중요 이슈
        - 전통적인 CPI 테스트용 프로토타입을 수량을 늘리는 부분 외에 모두 제작 되어 있어야 함
        - 즉, 컨텐츠가 대부분 제작되어 있어야 함
        - 분량에 따라 사실상 여론조사용이 될수 있음 
