...
- CPI TEST 단계에서는 보통 1-3개의 채널에서 CPI를 기본 지표로 하여 게임 초기단계의 시장성 테스트를 진행합니다.
- 제작 프로세스상 게임은 극초기의 플레이가 가능하고,
- 게임의 매커니즘이 이해될 수 있는 수준으로 제작하고,
- 설정된 예산 한도 내에서 제작한 크리에이티브를 사용하여 시장성 테스트를 진행합니다.
- 게임의 장르나 시장의 상황에 따라 다르게 판단할 수 있으나,
- 알로하팩토리에서는 일반적으로 CPI $1-2 내외를 기준으로 잡고 리텐션, 플레이타임, 이탈율 등의 게임지표와의 종합적 판단을 통해 시장성을 최종으로 검증합니다.
- 핵심 목표: 해당 컨셉이 시장에서 얼마나 잘 워킹하는가? 

 - UA 특징 : 게임의 컨셉을 빠르게 테스트 하기 위해 매체의 타겟팅 러닝 기간이 짧고 매체의 유저 POOL이 넓어 CPI 단가가 전체 게임의 시장성을 판단하기 적합한 매체를 선정 
- 주요 확인 지표: CPI 단가 
- 핵심 목표: 해당 컨셉이 시장에서 얼마나 잘 워킹하는가? 
UA 특징 : 게임의 컨셉을 빠르게 테스트 하기 위해 매체의 타겟팅 러닝 기간이 짧고 매체의 유저 POOL이 넓어 CPI 단가가 전체 게임의 시장성을 판단하기 적합한 매체를 선정 
주요 확인 지표: CPI 단가 
