...
|---|------|---|---|---|---|
|0|공격력|10 + (10 *(level-1))|0+(10*(level-1))|650|(10,20,30.. / 0,11,12..)| 
|1|체력|110 + (10 *(level-1))|0+(7*(level-1))|400|(110,120,1300.. / 0,7,8..)| 
|2|체력 회복|7.0 + (7 *(level-1))|0+(7*(level-1))|170|(7.0,7.7,8.4.. / 0,7,8..)| 
|3|공격 스피드|1.0 + (0.01 *(level-1))|0+(8*(level-1))|200|(1.00,1.01,1.02.. / 0,23,31..)| 
|4|크리티컬 확률|0.10% + (0.10 *(level-1))|0+(8*(level-1))|200|(0.10%,0.20%,0.30%.. / 0,23,31..)| 
